 ...
 * components/ReviewsWidgetSection.tsx. Same self-contained,
 * script-only embed pattern: injects its own markup via
 * document.currentScript, no container div needed.
 *
