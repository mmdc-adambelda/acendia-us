...
- **Run**: `0001_schema.sql` → `0002_rls_policies.sql` → `0003_seed_plans.sql` → `0004_seed_onboarding_items.sql` → `0006_add_went_live_at.sql` → `0007_rename_plans.sql` → **`0008_grants.sql`** → **`0009_service_role_grants.sql`** (skip 0007 if you're running everything fresh — 0003 already uses the new names). `0005_...` is a template, not a numbered step — see item 7 below.
